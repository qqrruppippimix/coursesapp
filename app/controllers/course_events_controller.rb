  ...
  def create
    ...
    respond_to do |format|
      if @course_event.save
        format.html { redirect_to @course_event, notice: 'Course event was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @course_event.update(course_event_params)
        format.html { redirect_to @course_event, notice: 'Course event was successfully updated.' }
